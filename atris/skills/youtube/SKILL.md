...
search QUERY (free)
   ...
   pick a URL --> notes URL (free, ephemeral unless --save)
    ...
    |                 notes keep a written yt_<id>.md (and ytnotes keeps a written en / en-orig / en-US / en-GB VTT) when yt-dlp exits 429
...
| notes 429 | YouTube rate-limited local captions | use a written yt_<id>.md if it exists; ytnotes keeps a written en / en-orig / en-US / en-GB VTT plus printed metadata; empty 429 still fails; do not use --paid |
