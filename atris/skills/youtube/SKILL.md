...
search QUERY (free)
   ...
   pick a URL --> notes URL (free, ephemeral unless --save)
    ...
    |                 watch, youtu.be, shorts, embed, live, and youtube-nocookie embed urls all resolve the same video id for that keep
